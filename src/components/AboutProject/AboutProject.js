...
function AboutProject() {
  return (
    <section id="about-project" className="about-project main__about-project">
      ...
      <p className="about-project__text about-project_text_location">Составление плана, работу над бэкендом, вёрстку, добавление функциональности и финальные доработки.</p>
